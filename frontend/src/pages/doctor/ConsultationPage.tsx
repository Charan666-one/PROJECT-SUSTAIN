...
export default function ConsultationPage() {
  ...
  const sendWhatsapp = async () => {
    ...
    setBusy("wa");
    try {
      const { data } = await prescriptionApi.sendWhatsapp(prescription.id);
      setPrescription(data);
    } finally { setBusy(""); }
  };
      ...
      <div>
        ...
        <div className="card">
          ...
          <p className="muted" style={{ marginTop: ".75rem" }}>
            Day 3, 7 and 30 follow-ups have been scheduled automatically.
          </p>
        </div>
      </div>
    );
    ...
    <div>
      ...
      <div className="grid consult-grid">
        ...
        <div className="card">
          ...
          <div className="row" style={{ marginTop: "1rem" }}>
            <button className="btn secondary" onClick={clarify} disabled={!!busy}>
              {busy === "clarify" ? "…" : "Clarify"}
            </button>
        ...
        <div>
          ...
          {rec && (
            <div className="card">
              ...
              <div className="row" style={{ marginTop: ".5rem" }}>
                {rec.sources.materia_medica.filter(Boolean).slice(0, 6).map((s, i) => (
          ...
          {rec && (
            <div className="card">
              ...
              <button className="btn sm secondary" type="button" onClick={() => setRemedies((rs) => [...rs, { ...EMPTY_REMEDY }])}>
                + Add remedy
              </button>
